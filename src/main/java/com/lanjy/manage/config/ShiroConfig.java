...
import com.lanjy.manage.filter.KickoutSessionFilter;
import com.lanjy.manage.shiro.RetryLimitHashedCredentialsMatcher;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(
		...
		// 未认证时（authc），指定跳转的界面/toLogin，登录时的链接
		shiroFilterFactoryBean.setLoginUrl("/toLogin");
		// 登录成功后要跳转的链接
		shiroFilterFactoryBean.setSuccessUrl("/home");
		// 未授权时（perms），指定跳转的界面/error;
...
//		// <!-- authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问【放行】-->
	...
	public DefaultAdvisorAutoProxyCreator advisorAutoProxyCreator() {
		...
		advisorAutoProxyCreator.setProxyTargetClass(true);//开启Shiro的注解(如@RequiresRoles,@RequiresPermissions)
